...
<body>
	...
	<table>
		...
		<tr><td>※</td><td>都道府県</td>
			<td><html:text property="uPrefAddress" /></td><tr>
		...
		<tr><td>※</td><td><bean:message key="password"/>（半角英数字）</td><td><html:password property="password" /></td></tr>
		<tr><td>※</td><td><bean:message key="password"/>（確認用）（半角英数字）</td><td><html:password property="passwordconf" /></td></tr>
		<tr><td></td><td>暗証番号は4桁の半角数字を入力してください。</td><td></td></tr>
		<tr><td>※</td><td><bean:message key="passno"/>（半角数字）</td><td><html:password property="passno" /></td></tr>
		<tr><td>※</td><td><bean:message key="passno"/>（確認用）（半角数字）</td><td><html:password property="passnoconf" /></td></tr>
