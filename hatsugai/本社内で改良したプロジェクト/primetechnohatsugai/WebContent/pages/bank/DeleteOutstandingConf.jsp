...
<body>
	...
	<html:form action="/DeleteOutstandingConfAction">
	<div><html:submit styleId="middle_button" property="deleteoutstandingConfAction">
		<bean:message key="delete"/>
	</html:submit>
	<html:submit styleId="middle_button" property="deleteoutstandingConfAction">
